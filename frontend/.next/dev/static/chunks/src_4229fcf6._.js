...
function ContactPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setSubmitting(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/restaurant/reserve`, {
                ...form,
                people: Number(form.people)
            });
            if (res.data.status === "confirmed") {
                setSuccess(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Reservation confirmed! We look forward to welcoming you.");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("No tables available for the selected criteria. Please try a different time or section.");
            }
        } catch  {
...
_s(ContactPage, "RL+yjaiRO84NMqqeHY0+T6a5JnE=");
_c = ContactPage;
var _c;
...
//# sourceMappingURL=src_4229fcf6._.js.map